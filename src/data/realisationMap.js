...
export const projectMap = [
    {title : "MyChat" ,description :"Une application de messagerie instantanée basée sur un serveur Node.js",video : myChatVideo ,icons :["javascript","html","css","node"],githubLink :"https://github.com/guillaume34110/multipassinbox" ,directLink:"https://multipassinbox.herokuapp.com/" ,fullDescription : "cette application est un chat en temps réel avec authentification et création de compte. Sur cette application il est possible de créer son compte pour pouvoir discuter avec les autres utilisateurs .Il y a un chat global pour tous les utilisateurs .Les utilisateurs peuvent ajouter des amis pour avoir des discussions privées." ,pictures : [myChat1,myChat2] },
